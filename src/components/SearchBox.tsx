...
<form className="max-w-md mx-auto py-3 " onSubmit={handleSubmit}>   
    ...
    <div className="relative">
        ...
        <button type="submit" disabled={search===''} className="text-white disabled:bg-black absolute end-2.5 bottom-2.5 bg-black hover:bg-black focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm px-4 py-2 dark:bg-black dark:hover:bg-black dark:focus:ring-black">Search</button>
    </div>
</form>
</div>
